        ...
        <div className="lg:flex-row lg:mt-20 lg:m-2 m-4 mt-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 gap-y-12">
            <div className="flex flex-col">
              <h1 className="text-white text-3xl font-bold lg:m-2 m-1">
                Let's Connect
              </h1>
              <div className=" flex mt-2 text-white m-1 ">
                ...
                <Link
                  href={"https://www.linkedin.com/in/shreya-singh-4b57a3229/"}
                >
            ...
            <div className="flex flex-col">
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col">
                  ...
                  <input
                    className="mt-2 rounded-[5px] p-2"
                    id="email"
                    type="email"
                    name="email"
                ...
                <div className="text-white flex flex-col ">
                  ...
                  <textarea
                    className="rounded-[5px] p-6 mt-3"
                    id="message"
                    name="message"
                ...
                {/* <div className="mt-4"> */}
                <button
                  className="text-white   lg:w-[100%]   p-3 text-1xl rounded-[8px] text-center  shadow  shadow-pink-600 font-bold m-1 border-1 w-[100%] border-pink-500 lg:mt-6 mt-10 bg-pink-500"
                  type="submit"
